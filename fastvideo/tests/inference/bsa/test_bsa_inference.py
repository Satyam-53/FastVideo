...
# # Fix libstdc++ ABI mismatch for flash_attn
...
# def main():
#     # Set the attention backend to VIDEO_SPARSE_ATTN
#     os.environ["FASTVIDEO_ATTENTION_BACKEND"] = "BSA_ATTN"

#     # Create a video generator with the model
...
#     # Define your prompt
#     prompt = "A dog walking in a garden"
